...
//int arr[]={10,11,16,18,19,60,61,66,68,69,80,81,86,89,90,91,96,98,99};
int main()
{
  int n;cin>>n;

if(n==1)cout<<"16"<<endl;
else if(n==2)cout<<"16 06"<<endl;
else if(n==3)cout<<"16 06 68"<<endl;
else if(n==4)cout<<"16 06 68 88"<<endl;
else cout<<"Glupenky Pierre"<<endl;
    rt 0;
}
